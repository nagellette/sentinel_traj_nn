...
train_data = '/Users/gengec/Desktop/code/data/mass_roads/train/sat/sat_img/'
train_label = '/Users/gengec/Desktop/code/data/mass_roads/train/map/map_img/'
...
training_generator = DataGenerator(train_data, train_label, batch_size=1, dim=IMAGE_DIMS, n_channels=3, n_classes=2, shuffle=False)
validation_generator = DataGenerator(valid_data, valid_label, batch_size=1, dim=IMAGE_DIMS, n_channels=3, n_classes=2, shuffle=False)

model.build([256, 256, 3])
print(model.summary())

csv_logger = tf.keras.callbacks.CSVLogger("./csv_logs/mass.csv", append=False, separator=",")
